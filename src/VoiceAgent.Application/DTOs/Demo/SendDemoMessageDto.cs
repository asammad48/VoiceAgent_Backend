...
public class SendDemoMessageResponseDto { public string Reply { get; set; } = string.Empty; public string CurrentState { get; set; } = string.Empty; public List<string> MissingSlots { get; set; } = new(); public object? CurrentCart { get; set; } public object? CurrentQuote { get; set; } public object? FinalResult { get; set; } public bool ShouldEndCall { get; set; } public string? EndReason { get; set; } }
